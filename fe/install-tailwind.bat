...
call npm install tailwindcss@^3.4.0 autoprefixer@^10.4.0 postcss@^8.4.0 @heroicons/vue@^2.0.0 lucide-vue-next@^0.300.0

REM Remove Vuetify dependencies
echo 🗑️ Removing Vuetify dependencies...
call npm uninstall vuetify @mdi/font
